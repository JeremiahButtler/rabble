...
((Drupal) => {
  const { isDesktopNav } = Drupal.rabble;
  ...
  Drupal.rabble.toggleSubNav = toggleSubNav;
  ...
  function handleBlur(e) {
    if (!Drupal.rabble.isDesktopNav()) return;
  ...
  Drupal.rabble.closeAllSubNav = closeAllSubNav;
  ...
  Drupal.rabble.areAnySubNavsOpen = areAnySubNavsOpen;
