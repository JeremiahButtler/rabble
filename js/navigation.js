...
((Drupal, once, tabbable) => {
  ...
  function init(props) {
    ...
    document.addEventListener('keyup', (e) => {
      if (e.key === 'Escape') {
        if (props.rabble.areAnySubNavsOpen()) {
          props.rabble.closeAllSubNav();
        } else {
   ...
   */
  Drupal.behaviors.rabbleNavigation = {
    attach(context) {
