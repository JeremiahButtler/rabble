...
namespace Drupal\Tests\rabble\Unit;

use Drupal\Tests\UnitTestCase;

/**
 * Tests the _rabble_hex_to_hsl() function.
 *
 * @group rabble
 */
final class rabbleHexToHslTest extends UnitTestCase {
  ...
  public function setUp(): void {
    parent::setUp();
    require_once __DIR__ . '/../../../rabble.theme';
  }
  ...
  public function testHexToHsl(string $hex, array $expected_hsl): void {
    self::assertEquals($expected_hsl, _rabble_hex_to_hsl($hex));
  }
